          ...
          <div className="hidden md:flex items-center space-x-4">
            {isLoggedIn ? (
              ...
              <>
                ...
                <Link href="/signup" className={`${isHomePage ? 'bg-white text-blue-600' : 'bg-blue-600 text-white'} hover:opacity-90 transition-opacity px-4 py-2 rounded-md text-sm font-medium`}>
                  회원가입
                </Link>
              </>
            )}
            ...
            <nav className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-4 pt-4 border-t border-gray-200">
                {isLoggedIn ? (
                  ...
                  <>
                    <Link href="/login" className={`${textColor} ${hoverColor} transition-colors py-2 text-base`}>
                      로그인
                    </Link>
                    <Link href="/signup" className={`${isHomePage ? 'bg-white text-blue-600' : 'bg-blue-600 text-white'} hover:opacity-90 transition-opacity py-2 px-4 rounded-md text-center text-base font-medium`}>
                      회원가입
                    </Link>
                  </>
                )}
