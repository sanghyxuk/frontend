      ...
      <div className="container mx-auto px-8 md:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Link href="/encryption">
            <div className="bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 p-8 rounded-2xl border border-emerald-500/30 card-hover relative cursor-pointer">
              ...
              <h3 className="text-xl font-semibold text-emerald-400 mb-3">File Encryption</h3>
          ...
          <Link href="/website-inspection">
            <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/10 p-8 rounded-2xl border border-blue-500/30 card-hover relative cursor-pointer">
              <div className="flex justify-between items-start mb-6">
              ...
              <h3 className="text-xl font-semibold text-blue-400 mb-3">Website Security Scan</h3>
              <p className="text-gray-300 text-sm mb-6">
