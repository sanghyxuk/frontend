...
export function FileEncryptionSection() {
  return (
    <section className="py-20 md:py-32 flex items-center justify-center bg-gradient-to-b from-blue-900/20 to-blue-800/10 snap-start">
      <div className="container mx-auto px-8 md:px-16">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6"> 
          ...
          <div className="bg-gray-800/50 p-4 md:p-6 rounded-xl border border-gray-700 card-hover">
            ...
            <h3 className="text-sm md:text-lg font-semibold text-white mb-3">Data Security</h3>
          ...
          <div className="bg-gray-800/50 p-4 md:p-6 rounded-xl border border-gray-700 card-hover">
            ...
            <h3 className="text-sm md:text-lg font-semibold text-white mb-3">Cloud Storage</h3>
            {/* ✅ 수정: hidden sm:block 클래스 제거 */}
            <p className="text-gray-400 text-xs md:text-sm">
          ...
          <div className="bg-gray-800/50 p-4 md:p-6 rounded-xl border border-gray-700 card-hover">
            ...
            <h3 className="text-sm md:text-lg font-semibold text-white mb-3">Instant Check</h3>
            {/* ✅ 수정: hidden sm:block 클래스 제거 */}
            <p className="text-gray-400 text-xs md:text-sm">
          ...
          <div className="bg-gray-800/50 p-4 md:p-6 rounded-xl border border-gray-700 card-hover">
            ...
            <h3 className="text-sm md:text-lg font-semibold text-white mb-3">Access Control & Audit</h3>
            {/* ✅ 수정: hidden sm:block 클래스 제거 */}
            <p className="text-gray-400 text-xs md:text-sm">
