      ...
      <div className="container mx-auto px-8 md:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 card-hover">
            ...
            <h3 className="text-lg font-semibold text-white mb-3">Threat Detection</h3>
          ...
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 card-hover">
            ...
            <h3 className="text-lg font-semibold text-white mb-3">Status Operations</h3>
            <p className="text-gray-400 text-sm">
          ...
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 card-hover">
            ...
            <h3 className="text-lg font-semibold text-white mb-3">Vulnerability & Patch</h3>
            <p className="text-gray-400 text-sm">
